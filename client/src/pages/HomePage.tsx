...
export function HomePage() {
  ...
  // If user is logged in as farmer, show only check eligibility
...
function AdminDashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-light-background dark:bg-dark-background flex items-center justify-center pt-20">
  ...
  return (
    <div className="pt-24 pb-16 px-4 bg-light-background dark:bg-dark-background min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold mb-2">
            Welcome back, <span className="bg-gradient-to-r from-saffron to-green bg-clip-text text-transparent">{user?.username || 'Admin'}!</span> 👋
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl p-6 border-2 border-blue-200 dark:border-blue-700 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:rotate-1"
          >
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-2xl p-6 border-2 border-purple-200 dark:border-purple-700 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:rotate-1"
          >
            <div className="flex items-center justify-between mb-4">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl p-6 border-2 border-green-200 dark:border-green-700 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:rotate-1"
          >
            <div className="flex items-center justify-between mb-4">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-2xl p-6 border-2 border-orange-200 dark:border-orange-700 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:rotate-1"
          >
            <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="space-y-3">
                    {recentActivity.recentFeedbacks.map((feedback: any, index: number) => (
                      <motion.div
                        ...
                        className="p-4 bg-light-muted dark:bg-dark-muted rounded-lg border border-light-border dark:border-dark-border transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:border-saffron"
                      >
                  ...
                  <div className="space-y-3">
                    {recentActivity.recentStories.map((story: any, index: number) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ delay: 0.1 * index }}
                        className="p-4 bg-light-muted dark:bg-dark-muted rounded-lg border border-light-border dark:border-dark-border transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:border-purple-500"
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                          ...
                          <span className="px-3 py-1 bg-purple/10 text-purple-600 dark:text-purple-400 rounded-full text-xs font-semibold">
                            Story
                          </span>
                        </div>
                      </motion.div>
            ...
            >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full px-4 py-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center justify-between"
                >
                ...
                <button
                  ...
                  className="w-full px-4 py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center justify-between"
                >
                ...
                <button
                  ...
                  className="w-full px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center justify-between"
                >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-light-muted-foreground dark:text-dark-muted-foreground font-semibold">
