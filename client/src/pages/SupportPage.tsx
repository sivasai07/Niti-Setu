...
import { Phone, Mail, MessageCircle, MapPin, Ticket } from 'lucide-react';
...
export function SupportPage() {
  ...
  useEffect(() => {
    ...
    // Redirect admins to support tickets page
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="mb-12 text-center">
              ...
              <p className="text-light-muted-foreground dark:text-dark-muted-foreground text-lg mb-6">
