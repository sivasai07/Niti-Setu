  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${
        isScrolled
          ? 'bg-white/95 dark:bg-dark-background/95 backdrop-blur-lg shadow-md border-light-border dark:border-dark-border'
          : 'bg-white/80 dark:bg-dark-background/80 backdrop-blur-sm border-light-border/50 dark:border-dark-border/50'
      }`}
    >
        ...
        {showLogoutModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-dark-background rounded-2xl shadow-2xl max-w-md w-full p-8 border border-light-border dark:border-dark-border mx-4"
              ...
              <div className="text-center">
                ...
                <div className="flex gap-3">
                  ...
                  <motion.button
                    ...
                    className="flex-1 px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold transition-all duration-300"
                  >
                    Yes, Logout
                  </motion.button>
                </div>
